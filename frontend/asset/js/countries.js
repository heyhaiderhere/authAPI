...
var industry_arr = new Array("Agriculture", "Commerce", "Education", "Financial Services", "Gaming", "Hospitality", "Health", "Leisure & Entertainment", "Utilities", "Logistics", "Non-profits", "Travel");

//Category
var c_a = new Array();
c_a[0]="";
c_a[1]="Agricultural Cooperatives|Agricultural Services";
c_a[2]="Automobiles|Digital Goods|Physical Goods|Real Estate|Digital Services|Legal Services|Physical Services|Professional Services";
c_a[3]="Nursery Schools|Primary Schools|Secondary Schools|Tertiary Institutions|Vocational Training|Virtual Learning|Other Educational Services";
c_a[4]="Financial Cooperatives|Corporate Services|Cryptocurrency Exchanges|Payment Solution Service Providers|Insurance|Investments|Agricultural Investments|Lending|Bill Payments|Payroll|Remittances|Savings|Mobile Wallets";
c_a[5]="Betting|Lotteries|Prediction Services";
c_a[6]="Hotels|Restaurants";
c_a[7]="Gymns|Hospitals|Pharmacies|Herbal Medicine|Telemedicine";
c_a[8]="Cinemas|Nightclubs|Events|Press & Media|Recreation Centres|Streaming Services";
c_a[9]="Professional Associations|Government Agencies|NGOs|Political Parties|Religious Organizations";
c_a[10]="Airlines|Ridesharing|Tour Services|Transportation|Travel Agencies";
c_a[11]="Cable Television|Electricity|Garbage Diposal|Internet|Telecoms|Water";
// States
...
function populateCategory( industryElementId, categoryElementId ){
	
	var selectedIndustryIndex = document.getElementById( industryElementId ).selectedIndex;

	var categoryElement = document.getElementById( categoryElementId );
	
	categoryElement.length=0;	// Fixed by Julian Woods
	categoryElement.options[0] = new Option('Select Category','');
	categoryElement.selectedIndex = 0;
	
	var category_arr = c_a[selectedIndustryIndex].split("|");
...
function populateIndustry(industryElementId, categoryElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	...
	if( categoryElementId ){
		industryElement.onchange = function(){
			populateCategory( industryElementId, categoryElementId );
		};
	}
}